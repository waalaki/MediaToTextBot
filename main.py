...
def handle_media(message):
    ...
    try:
        ...
        subprocess.run(["ffmpeg", "-y", "-i", tmp_in_path, "-ar", "16000", "-ac", "1", "-b:a", "64k", tmp_out_path], check=True, stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL)
        ...
        bot.edit_message_text("Transcribing completed! ✅", message.chat.id, status_msg.message_id)
        time.sleep(1)
        try:
