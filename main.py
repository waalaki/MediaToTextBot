...
user_selected_lang = {}
user_processing = {}
user_processing_lock = threading.Lock()
...
def handle_media(message):
    ...
    if not try_acquire_user(uid):
        bot.reply_to(message, "Wait brother while I write your old file 💗")
        return
