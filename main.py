...
<body>
    ...
    <div class="container my-5">
        ...
        <h3 class="text-center mb-4">🤖 Bot Capabilities</h3>
        <div class="row text-center">
            <div class="col-md-4 mb-4">
                <div class="card feature-card p-3">
                    <div class="card-body">
                        <h5 class="card-title text-primary">🎙️ Transcription</h5>
            ...
            <div class="col-md-4 mb-4">
                <div class="card feature-card p-3">
                    <div class="card-body">
                        <h5 class="card-title text-success">🌐 Translation</h5>
            ...
            <div class="col-md-4 mb-4">
                <div class="card feature-card p-3">
                    <div class="card-body">
                        <h5 class="card-title text-danger">📝 Summarization</h5>
        ...
        <h3 class="text-center mt-5 mb-3">⚙️ Technical Details</h3>
...
async def send_welcome(client, message: Message):
    ...
    if message.text and message.text.split()[0] == "/help":
        welcome_text = (
