...
def upload_and_transcribe_gemini(file_path: str, key: str, uid: int) -> str:
    ...
    try:
        ...
        # Delete the uploaded file from the Gemini API service
        if uploaded_file:
            try: client.files.delete(name=uploaded_file.name)
            except Exception as e: logging.warning(f"Failed to delete uploaded file: {e}")
