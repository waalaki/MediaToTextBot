...
@flask_app.route("/upload/<token>", methods=["GET", "POST"]) # Qaladkaan wuu hagaagay
...
@flask_app.route("/", methods=["GET"]) # Qaladkaan wuu hagaagay
def index():
    return "Bot Running", 200

@flask_app.route(WEBHOOK_PATH, methods=["POST"]) # Qaladkaan wuu hagaagay
def webhook():
