...
def send_promo(chat_id):
    promo_text = "If you want high-quality STT that is 100% accurate and additional features like summarization or translation, or if you need to send files larger than 20MB, use @MediaToTextBot"
